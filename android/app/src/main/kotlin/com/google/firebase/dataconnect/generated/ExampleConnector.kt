...
public interface ExampleConnector : com.google.firebase.dataconnect.generated.GeneratedConnector<ExampleConnector> {
  override val dataConnect: com.google.firebase.dataconnect.FirebaseDataConnect
    ...
    public val getMyReviews: GetMyReviewsQuery
  
    public val listPublicMovieLists: ListPublicMovieListsQuery
  
    public val seedDemoData: SeedDemoDataMutation
...
private class ExampleConnectorImpl(
  override val dataConnect: com.google.firebase.dataconnect.FirebaseDataConnect
    ...
    override val getMyReviews by lazy(LazyThreadSafetyMode.PUBLICATION) {
      GetMyReviewsQueryImpl(this)
    }
  
    override val listPublicMovieLists by lazy(LazyThreadSafetyMode.PUBLICATION) {
      ListPublicMovieListsQueryImpl(this)
    }
  
    override val seedDemoData by lazy(LazyThreadSafetyMode.PUBLICATION) {
      SeedDemoDataMutationImpl(this)
    }
...
private class GetMyReviewsQueryImpl(
  connector: ExampleConnector
):
  GetMyReviewsQuery,
  ExampleConnectorGeneratedQueryImpl<
  ...
  >(
    connector,
    GetMyReviewsQuery.Companion.operationName,
    GetMyReviewsQuery.Companion.dataDeserializer,
    GetMyReviewsQuery.Companion.variablesSerializer,
  )


private class ListPublicMovieListsQueryImpl(
  connector: ExampleConnector
):
  ListPublicMovieListsQuery,
  ExampleConnectorGeneratedQueryImpl<
      ListPublicMovieListsQuery.Data,
      Unit
  >(
    connector,
    ListPublicMovieListsQuery.Companion.operationName,
    ListPublicMovieListsQuery.Companion.dataDeserializer,
    ListPublicMovieListsQuery.Companion.variablesSerializer,
  )


private class SeedDemoDataMutationImpl(
  connector: ExampleConnector
):
  ...
  >(
    connector,
    SeedDemoDataMutation.Companion.operationName,
    SeedDemoDataMutation.Companion.dataDeserializer,
    SeedDemoDataMutation.Companion.variablesSerializer,
  )
